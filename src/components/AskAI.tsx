...
export default function AskAI() {
  ...
  const [messages, setMessages] = useState<AIMessage[]>([
    {
      id: '1',
      content: "Hi! I'm Gaurav's AI assistant. Feel free to ask me anything about his experience, projects, or skills!",
      role: 'assistant',
      timestamp: new Date(),
    },
  ]);
          ...
          >
            ...
            <div className="bg-gradient-primary p-4 flex items-center justify-between">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h3 className="font-semibold text-primary-foreground">Ask AI</h3>
                  ...
                  <div className="border-t border-border/50 p-4">
                    <div className="flex space-x-2">
                      <Input
                        ...
                        className="flex-1 bg-input/50 border-border/50 focus:border-primary text-sm"
                        disabled={isLoading}
                      />
                      <Button
